...
public class MyPlayerMaterialAssignerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("No skins with 'average_sleeves' model found. Make sure skin_data JSON files are in Resources/Data/skin_data/", MessageType.Warning);
        }
    ...
    private void RefreshAvailableSkins()
    {
